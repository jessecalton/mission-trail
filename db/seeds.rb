...
insta_event1 = Event.create(name: "good-insta", text: "You have 11 Insta likes. You are happy.", attr_change_id: 3, image_url: "/assets/instagram.png" )
insta_event2 = Event.create(name: "bad-insta", text: "You have 3 Instagram likes. Sucks to be you.", attr_change_id: 2, image_url: "/assets/instagram.png")

### Tinder Events ###

tinder_event1 = Event.create(name: "good-tinder", text: "You have a hot coconut water date with a hot yoga instructor.", attr_change_id: 3, image_url: "/assets/tinder.png")
tinder_event2 = Event.create(name: "neutral-tinder", text: "You have no new Tinder matches.", attr_change_id: 1, image_url: "/assets/tinder.png")
tinder_event3 = Event.create(name: "bad-tinder", text: "You text a hot match and you get a reply saying 'new phone who dis?'", attr_change_id: 2, image_url: "/assets/tinder.png")
...
average_game_ending = Event.create(name: "average-game-ending", text: "The Party is OK. You pretend to have the greatest time ever to seem cool.")
bad_game_ending = Event.create(name: "bad-game-ending", text: "You reached the party. Its sucks, you wished you stayed home rewatching on 'Friends' again")
good_game_ending = Event.create(name: "good-game-ending", text: "The Party is the greatest ever. People love your small talk and hipster style")
