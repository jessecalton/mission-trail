...
result2 = Result.create(text: "Well, that was awkward.", option_id: option2.id, attr_change_id: attr_change1.id, event_id: event.id, image_url: "/assets/smile.png")
...
result4 = Result.create(text: "You kicked them and ran! Serves 'em right! That relationship was the worst two weeks ever!", option_id: option4.id, attr_change_id: attr_change2.id, event_id: event.id, image_url: "/assets/smile.png")
...
micro_dosing_result1 = Result.create(text: "You micro-dosed and nobody thinks you're a square. However, your FOMO starts to kick in and you wish you were back home playing Oregon Trail.", option_id: micro_dosing_option1.id, attr_change_id: 2, event_id: micro_dosing_event.id, image_url: "/assets/micro_doser.jpg")
micro_dosing_result2 = Result.create(text: "You passed on the micro-dose. Trends are totally not your thing.", option_id: micro_dosing_option2.id, attr_change_id: 3, event_id: micro_dosing_event.id, image_url: "/assets/micro_doser.jpg")
...
mix_tape_result1 = Result.create(text: "You bought the mix tape for $5. It's a scratched up CD-R and you don't own anything that plays CDs, but you tell all your friends it's straight fire, yo.", option_id: mix_tape_option1.id, attr_change_id: 8, event_id: mix_tape_event.id, image_url: "/assets/mixtape.jpg")

mix_tape_result2 = Result.create(text: "You passed on the mix tape. The Chainsmokers are more your cup of white cherry blossom tea anyways.", option_id: mix_tape_option2.id, attr_change_id: 1, event_id: mix_tape_event.id, image_url: "/assets/mixtape.jpg")
...
### Talk to Locals 11 ###
local_event_11 = Event.create(name: "local-grizzly-beard", text: "A grizzly-bearded dude starts walking alongside you. 'I see you're rockin' a face blanket man. Try out this new non-GMO hempseed beard oil. It'll change your life.'", attr_change_id: 3, image_url: "/assets/bearded_dude.jpg")
